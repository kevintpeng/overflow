...
ActiveRecord::Schema.define(version: 20160206190733) do
  ...
  add_index "tagging_relationships", ["tag_id"], name: "index_tagging_relationships_on_tag_id", using: :btree
  add_index "tagging_relationships", ["topic_id"], name: "index_tagging_relationships_on_topic_id", using: :btree
  ...
  add_foreign_key "tagging_relationships", "tags"
  add_foreign_key "tagging_relationships", "topics"
end
